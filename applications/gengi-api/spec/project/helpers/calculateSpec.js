...
describe('Helpers > calculate', () => {
  describe('toISK(rate, value)', () => {
    ...
    it('should be a function', done => {
      assert(
        typeof calculate.toISK === 'function',
        'expected calculate.toISK to be a function'
      )
      done()
    })
  ...
  describe('ensureCurrency(code)', () => {
    it('should exist', done => {
      assert(
        calculate.hasOwnProperty('ensureCurrency'),
    ...
    it('should be a function', done => {
      assert(
        typeof calculate.ensureCurrency === 'function',
        'expected calculate.ensureCurrency to be a function'
      )
      done()
    })
  ...
  describe('ensureValue(value)', () => {
    it('should exist', done => {
      assert(
        calculate.hasOwnProperty('ensureValue'),
        'expected to have property'
      )
      done()
    })
    ...
    it('should be a function', done => {
      assert(
        typeof calculate.ensureValue === 'function',
        'expected calculate.ensureValue to be a function'
      )
      done()
    })
